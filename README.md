...
- Uses optimized current-limiting resistors (270 Ohm) for safety and brightness.
- Simple, efficient code using arrays for easy expandability.

## Components
- 1x Arduino Uno
- 7x LEDs (Various colors)
